...
def get_all_defensive_first_teams():
    try:
        result = (
            supabase.table("player_awards")
            .select("season")
            .eq("description", "All-Defensive Team")
        ...
        print(f"Error fetching All-Defensive First Teams: {e}")
        return []
...
def insert_theme(season):
    ...
    SELECT DISTINCT
        ...
        person_id
    FROM player_awards
    WHERE description = 'All-Defensive Team'
    ...
    try:
        result = (
            ...
            .insert(
                {
                    "theme": f"{season} First Team All-Defense",
                    "theme_description": "All-Defensive First Teams",
                    "sql_query": sql_query,
...
def main():
    seasons = get_all_defensive_first_teams()
    if not seasons:
    ...
    for season_data in seasons:
        ...
        print(f"\nProcessing {season} First Team All-Defense...")
        ...
        if players:
            ...
            print(f"Successfully processed {season} First Team All-Defense")
        else:
            print(f"No players found for {season} First Team All-Defense")
