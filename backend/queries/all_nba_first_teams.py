...
def get_all_nba_first_teams():
    try:
        ...
        print(f"Error fetching All-NBA First Teams: {e}")
        return []
...
def insert_theme(season):
    ...
    try:
        result = (
            ...
            .insert(
                {
                    "theme": f"{season} First Team All-NBA",
                    "theme_description": "All-NBA First Teams",
                    "sql_query": sql_query,
...
def main():
    seasons = get_all_nba_first_teams()
    if not seasons:
    ...
    for season_data in seasons:
        ...
        print(f"\nProcessing {season} First Team All-NBA...")
        ...
        if players:
            ...
            print(f"Successfully processed {season} First Team All-NBA")
        else:
            print(f"No players found for {season} First Team All-NBA")
